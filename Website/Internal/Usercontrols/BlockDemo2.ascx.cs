...
public partial class GraphiteInternal_BlockDemo2 : System.Web.UI.UserControl
{
    ...
    private void GetDemoCss()
    {
        ...
        {
            string strCssCode = Graphite.Internal.Demo.GetSourceCode(".scss", dicFiles["css"], GetActiveIndex(), path, config);
