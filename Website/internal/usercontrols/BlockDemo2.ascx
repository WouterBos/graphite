<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BlockDemo2.ascx.cs" Inherits="GraphiteInternal_BlockDemo2" %><!-- Graphite: Ignore Codefile -->
...
<div id="graphite_demoStage">
    ...
    <div class="graphite_demoStage">
        ...
        <iframe runat="server" id="iframe" frameborder="0" class="graphite_demoStage_frame"></iframe>
    </div>
