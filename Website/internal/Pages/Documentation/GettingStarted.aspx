...
<asp:Content ID="Intro" ContentPlaceHolderID="Intro" Runat="Server">
    <div class="gp_block gp_textBlock">
        <article>
            ...
            <p>Graphite is a website template and a codebase. You can start building your website by downloading Graphite.</p>
            
            <p>mostly a website with many UI demos. Most demos are intentionally kept simple to keep them extendable. If you find something you'd like to use, copy the code by pressing the black buttons below the demo.</p>
        </article>
    </div>
</asp:Content>
